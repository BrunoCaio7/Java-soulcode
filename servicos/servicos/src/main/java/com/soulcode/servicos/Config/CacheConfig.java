...
public class CacheConfig {
    ...
    @Bean
    public RedisCacheConfiguration cacheConfiguration() { // customizar a config padrão de redis cache
        return RedisCacheConfiguration
                .defaultCacheConfig()  //  customizar informações padrões
                .entryTtl(Duration.ofMinutes(5)) // todos os caches teráo 5 minutos por padrão (tempo de vida)
